...
#         print(docs[0])
        ...
        content = "\n\n".join(doc.page_content+"\n\n\n"+"PDF Title:"+doc.metadata['title']+'\nPDF Source:'+doc.metadata['source']+"\nPage:"+str(doc.metadata['page']) for doc in docs)
...
#         print(content)
        ...
        prompt = ChatPromptTemplate.from_messages([
                    ...
                    2.Keep the answer as concise as possible. Try to explain as descriptive as possible.
                    3.Generate answer only from the context given. Make sure the answer is long and descriptive.
                    4.Always say "thanks for asking!" at the end of the answer
                    5.Cite the Title and Source Url at the bottom of response  from all the context."""),
